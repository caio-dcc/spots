  ...
  return (
    <div className="p-8 w-full h-full animate-in fade-in duration-500 overflow-y-auto">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* Modo Noturno */}
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div><h2 className="text-lg font-semibold text-zinc-900 dark:text-white flex items-center gap-2"><Moon className="w-5 h-5 text-zinc-400" />Modo Noturno</h2><p className="text-sm text-zinc-500 mt-1">Alterne o tema visual do painel.</p></div>
          <Button onClick={toggleDarkMode} className="px-4 py-2 bg-zinc-900 dark:bg-white text-white dark:text-black hover:bg-zinc-800 dark:hover:bg-zinc-100 cursor-pointer flex items-center gap-2"><Moon className="w-4 h-4" />Alternar Tema</Button>
        </div>
