...
const CircularText: React.FC<CircularTextProps> = ({
  ...
  return (
    <motion.div
      className={`m-0 mx-auto rounded-full w-[250px] h-[250px] relative font-black text-white text-center cursor-pointer origin-center ${className}`}
    ...
    >
      {letters.map((letter, i) => {
        ...
        const radius = 102; // Reduzido em 15% (de 120 para 102)
