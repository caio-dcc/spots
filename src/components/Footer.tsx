    ...
    <footer className="py-6 border-t border-white/10 bg-black/50 backdrop-blur-md relative z-10">
      <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-6">
          <a href="https://wa.me/5521974026883" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/5 rounded-xl text-zinc-500 hover:text-white transition-all hover:scale-110 cursor-pointer">
            <MessageCircle className="w-5 h-5" />
          </a>
          <a href="https://www.linkedin.com/in/caio-marques-682446234/" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white/5 rounded-xl text-zinc-500 hover:text-white transition-all hover:scale-110 cursor-pointer">
          ...
          <a href="mailto:dev.caio.marques@gmail.com" className="p-2.5 bg-white/5 rounded-xl text-zinc-500 hover:text-white transition-all hover:scale-110 cursor-pointer">
